...
export function OutreachDraftPanel({ leadId, role, drafts, evidence, recipient, salesApproved, onChanged, allowGenerate = true, allowSendActions = true }: Props) {
